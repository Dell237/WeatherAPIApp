        ...
        btn_getWeatherByID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               weatherDataService.getCityForecastByID(et_dataInput.getText().toString(), new WeatherDataService.ForeCastByIDResponse() {
                   @Override
                   public void onError(String message) {
                       Toast.makeText(MainActivity.this, "returned an Error  " , Toast.LENGTH_SHORT).show();
                   ...
                   public void onResponse(List<WeatherRepotModel> weatherRepotModels) {
                       ...
                       ArrayAdapter arrayAdapter = new ArrayAdapter(MainActivity.this, android.R.layout.simple_list_item_1, weatherRepotModels);
